...
const ProjectDetails = () => {
  ...
  return (
    <div className="min-h-screen w-screen text-white/70 relative p-[7vw]">
            ...
            <h2 ref={numRef} className="absolute lg:text-[1vw] text-[3.2vw] left-[6.6] lg:left-[5vw] top-[17vw] lg:top-[4vw]">Project {project.id}</h2>
            ...
            <img  className="h-[42vw] w-[72vw] translate-x-[-50%] object-cover object-center mt-[12vw] opacity-80 relative left-[50%] rounded-xl" src={project.image} alt="" />
            </Link>
